<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DSOFOS.User.Default" %>
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Online Food Ordering System This project aimed at developing an online food ordering system which can be used in small places, and medium cities firstly and then on a large scale. It is developed to help restaurants to simplify their daily operational and managerial task as well as improve the dining experience of customers.
                </p>
                <h6>
                  DSOFOS
                </h6>
...
Easier ordering process – People love to boss around there orders. When the companies are introducing apps or website for there business on the internet, no more need for human interaction with the customer.
                </p>
                <h6>
                  DSOFOS
                </h6>
